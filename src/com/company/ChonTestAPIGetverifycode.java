...
public class ChonTestAPIGetverifycode {
    ...
    public static void TestGet_verify_code() throws Exception {
        boolean k = true;
        while (k) {
            System.out.println("1 - Người dùng gọi request này lại khi mà chưa nhận được hoặc làm mất mã xác thực.\n\n "+
                    "2 - Người dùng liên tục gửi request này lại trong thời gian quá ngắn.\n\n"+
                    "3 - Người dùng truyền tham số với số điện thoại đã được hoàn tất quy trình đăng ký (tức\n" +

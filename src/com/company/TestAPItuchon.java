...
public class TestAPItuchon {
    public static void giaodientuchon() throws Exception {
        ...
        if(url.contains("signup")) {
        	...
        	ChonTestAPICheck_new_items.link = url; //gán link url gọi API signUp
            System.out.println(url); //kiểm tra lại link url
            System.out.println("Nhập tài khoản chưa đăng ký");
            ChonTestAPICheck_new_items.TestCheck_new_items(); //Chọn Test Case muốn test với API Sign Up, sau đó thực thi test case đã chọn
        }
    }
